...
class MessagesController extends GetxController {
  late final uploading = false.obs;
  late var message = Message([]).obs;
  late ChatRepository _chatRepository;
  late NotificationRepository _notificationRepository;
  late AuthService _authService;
  late var messages = <Message>[].obs;
  late var chats = <Chat>[].obs;
  late File imageFile;
  late Rx<DocumentSnapshot> lastDocument = new Rx<DocumentSnapshot>(null);
  late final isLoading = true.obs;
  late final isDone = false.obs;
  late ScrollController scrollController = ScrollController();
  late final chatTextController = TextEditingController();
