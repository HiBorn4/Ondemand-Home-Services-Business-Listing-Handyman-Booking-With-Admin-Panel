...
import '../../../../common/repositories/slider_repository.dart';
...
class HomeController extends GetxController {
  ...
  late final addresses = <Address>[].obs;
  late final slider = <Slide>[].obs;
  late final currentSlide = 0.obs;

  late final eServices = <EService>[].obs;
  late final categories = <Category>[].obs;
  late final featured = <Category>[].obs;
