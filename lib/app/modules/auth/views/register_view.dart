                ...
                if (controller.loading.isTrue) {
                  return CircularLoadingWidget(
                    ...
                    onComplete: (void callback) {
                      // Define the action to be taken when loading is complete
                    },
                    onCompleteText:
                        "Loading Complete", // Provide a text for onCompleteText
                  );
                } else {
                  return Column(
                    ...
                    children: [
                      TextFieldWidget(
                        ...
                        validator: (input) {
                          if (input != null && input.length < 3) {
                            return "Should be more than 3 characters".tr;
                          } else {
                      ...
                      TextFieldWidget(
                        ...
                        validator: (input) => (input?.contains('@') == true)
                            ? null
